//DA5 use earlier ADC code to transmit ADC value of internal temp sensor
//between two RF modules 
//Atmega will also alternate between TX and RX modes every 0.5s
//Additional commented sections were for testing 
...
int main(void)
{
	...
	strcpy(tx_message,"Wiggidy Wack");	// Copies string into array.
	...
	while (1)
	{
		...
		//USART_print(temp);
		//Above should cause terminal window to pop up 
		//and also show a value maybe ???
		_delay_ms(2000);
